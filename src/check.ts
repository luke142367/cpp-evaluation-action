...
if (!GITHUB_TOKEN) {
    throw new Error('GITHUB_TOKEN not defnied')
}
...
async function updateCheck(id : number, conclusion : Conclusion,
                           output : Octokit.ChecksUpdateParamsOutput | undefined = undefined) {
